  ...
  return (
    <div className="relative min-h-screen overflow-hidden font-body" style={{ backgroundColor: "#0a0a0a", color: "#f5f5f5" }}>
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 right-1/4 w-[500px] h-[500px] rounded-full filter blur-[130px] opacity-10" style={{ backgroundColor: "#89AACC" }} />
        <div className="absolute bottom-0 left-1/4 w-[400px] h-[400px] rounded-full filter blur-[110px] opacity-8" style={{ backgroundColor: "#4E85BF" }} />
      </div>
        ...
        <div className="w-full max-w-7xl mx-auto px-2 sm:px-4">
          ...
          <div className="text-center mb-12 sm:mb-16 md:mb-20">
            <div className="relative inline-block mb-6 rounded-3xl overflow-hidden group">
              <div className="absolute -inset-1 rounded-3xl blur-sm opacity-50 group-hover:opacity-75 transition duration-1000" style={{ background: "linear-gradient(90deg, #89AACC, #4E85BF, #89AACC)" }} />
              <div className="relative backdrop-blur-xl p-8 sm:p-10 md:p-12 border rounded-3xl" style={{ backgroundColor: "rgba(20,20,20,0.95)", borderColor: "rgba(137,170,204,0.2)" }}>
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-4 tracking-tight font-display italic">
                  Junxi (Duke) Hu
                </h1>
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 text-sm sm:text-base md:text-lg flex-wrap">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="p-2 rounded-lg border" style={{ backgroundColor: "rgba(137,170,204,0.1)", borderColor: "rgba(137,170,204,0.2)" }}>
                      <Mail size={18} style={{ color: "#89AACC" }} />
                    </div>
                    <a href="mailto:hjxduke080111@gmail.com" style={{ color: "rgba(245,245,245,0.8)" }} className="hover:text-[#89AACC] transition-colors">
          ...
          <div className="mb-12 sm:mb-16 md:mb-20">
            <div className="flex items-center gap-3 mb-8 sm:mb-10 group">
              <div className="relative p-3 rounded-xl border overflow-hidden" style={{ backgroundColor: "rgba(137,170,204,0.1)", borderColor: "rgba(137,170,204,0.3)" }}>
                <GraduationCap size={28} style={{ color: "#89AACC" }} />
              </div>
            ...
            <div className="relative bg-gradient-to-br from-[#0a1628]/80 to-[#000811]/80 backdrop-blur-xl rounded-3xl p-6 sm:p-8 border border-[#89AACC]/30 hover:border-[#89AACC]/50 transition-all duration-300 hover:shadow-2xl hover:shadow-[#89AACC]/20 group">
              {/* Corner accents */}
              <div className="absolute top-0 left-0 w-20 h-20 border-t-2 border-l-2 border-[#89AACC]/30 rounded-tl-3xl group-hover:border-[#89AACC]/60 transition-all duration-300" />
              <div className="absolute bottom-0 right-0 w-20 h-20 border-b-2 border-r-2 border-[#89AACC]/30 rounded-br-3xl group-hover:border-[#89AACC]/60 transition-all duration-300" />
              <div className="space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 border-b border-[#89AACC]/20 pb-4">
                  <h3 className="text-xl sm:text-2xl font-bold text-[#89AACC]">{futureEducation.school}</h3>
                  <span className="text-base sm:text-lg text-white/80 font-medium">{futureEducation.period}</span>
                </div>
                <div className="space-y-2">
                  <p className="text-base text-white">
                    <span className="font-semibold text-[#89AACC]/70">Degree:</span> {futureEducation.degree}
                  </p>
                  <div className="text-base text-white">
                    <span className="font-semibold text-[#89AACC]/70">Certificate:</span>
          ...
          <div className="mb-12 sm:mb-16 md:mb-20">
            <div className="flex items-center gap-3 mb-8 sm:mb-10 group">
              <div className="relative p-3 rounded-xl bg-gradient-to-br from-[#89AACC]/20 to-[#053154]/20 border border-[#89AACC]/40 group-hover:border-[#89AACC]/60 transition-all duration-300 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-[#89AACC]/0 via-[#89AACC]/20 to-[#4E85BF]/0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700" />
                <Users size={28} className="relative text-[#89AACC]" />
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {leadership.map((item, index) => (
                <div key={index} className="relative bg-gradient-to-br from-[#0a1628]/80 to-[#000811]/80 backdrop-blur-xl rounded-2xl p-6 border border-[#89AACC]/30 hover:border-[#89AACC]/50 hover:shadow-xl hover:shadow-[#89AACC]/20 transition-all duration-300">
                  <div className="space-y-4">
                    <div>
                      <h3 className="text-xl font-bold text-[#89AACC] mb-1">{item.title}</h3>
                    ...
                    <ul className="space-y-2">
                      {item.highlights.map((highlight, hIndex) => (
                        <li key={hIndex} className="flex items-start gap-2 text-sm text-white/90">
                          <Target size={16} className="text-[#89AACC] mt-0.5 flex-shrink-0" />
                          <span>{highlight}</span>
                        </li>
                      ))}
                    </ul>
          ...
          <div className="mb-12 sm:mb-16 md:mb-20">
            <div className="flex items-center gap-3 mb-8 sm:mb-10 group">
              <div className="relative p-3 rounded-xl bg-gradient-to-br from-[#89AACC]/20 to-[#053154]/20 border border-[#89AACC]/40 group-hover:border-[#89AACC]/60 transition-all duration-300 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-[#89AACC]/0 via-[#89AACC]/20 to-[#4E85BF]/0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700" />
                <BookOpen size={28} className="relative text-[#89AACC]" />
              </div>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold">
                <span className="">
            ...
            <div className="space-y-4">
              {academics.map((item, index) => (
                <div key={index} className="relative bg-gradient-to-br from-[#0a1628]/80 to-[#000811]/80 backdrop-blur-xl rounded-xl p-6 border border-[#89AACC]/30 hover:border-[#89AACC]/50 hover:shadow-lg hover:shadow-[#89AACC]/20 transition-all duration-300">
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 mb-3">
                    <div className="flex-1">
                      <h3 className="text-lg sm:text-xl font-bold text-[#89AACC]">{item.title}</h3>
          ...
          <div className="mb-12 sm:mb-16 md:mb-20">
            <div className="flex items-center gap-3 mb-8 sm:mb-10 group">
              <div className="relative p-3 rounded-xl bg-gradient-to-br from-[#89AACC]/20 to-[#053154]/20 border border-[#89AACC]/40 group-hover:border-[#89AACC]/60 transition-all duration-300 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-[#89AACC]/0 via-[#89AACC]/20 to-[#4E85BF]/0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700" />
                <Heart size={28} className="relative text-[#89AACC]" />
              </div>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold">
                <span className="">
                  Interests
          ...
          <div className="mb-12 sm:mb-16 md:mb-20">
            <div className="flex items-center gap-3 mb-8 sm:mb-10 group">
              <div className="relative p-3 rounded-xl bg-gradient-to-br from-[#89AACC]/20 to-[#053154]/20 border border-[#89AACC]/40 group-hover:border-[#89AACC]/60 transition-all duration-300 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-[#89AACC]/0 via-[#89AACC]/20 to-[#4E85BF]/0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700" />
                <Trophy size={28} className="relative text-[#89AACC]" />
              </div>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold">
                <span className="">
                  Awards & Honors
            ...
            <div className="relative bg-gradient-to-br from-[#0a1628]/80 to-[#000811]/80 backdrop-blur-xl rounded-2xl p-6 sm:p-8 border border-[#89AACC]/30">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {awards.map((award, index) => (
                  <div key={index} className="bg-[#1a1a1a]/40 rounded-xl p-4 border border-[#89AACC]/30 hover:border-[#89AACC]/50 hover:shadow-md hover:shadow-[#89AACC]/10 transition-all duration-300">
                    <div className="flex items-start gap-3">
                      <Award size={20} className="text-[#89AACC] mt-1 flex-shrink-0" />
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-[#89AACC]/80 font-medium">{award.year}</p>
                      </div>
                    </div>
                  </div>
                ))}
          ...
          <div className="mb-12 sm:mb-16 md:mb-20">
            <div className="flex items-center gap-3 mb-8 sm:mb-10 group">
              <div className="relative p-3 rounded-xl bg-gradient-to-br from-[#89AACC]/20 to-[#053154]/20 border border-[#89AACC]/40 group-hover:border-[#89AACC]/60 transition-all duration-300 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-[#89AACC]/0 via-[#89AACC]/20 to-[#4E85BF]/0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700" />
                <Code size={28} className="relative text-[#89AACC]" />
              </div>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold">
                <span className="">
            ...
            <div className="relative bg-gradient-to-br from-[#0a1628]/80 to-[#000811]/80 backdrop-blur-xl rounded-2xl p-6 sm:p-8 border border-[#89AACC]/30">
              <div className="space-y-6">
                {computationalSkills.map((skill, index) => (
                  <div key={index} className="bg-[#1a1a1a]/40 rounded-xl p-5 border border-[#89AACC]/20 hover:border-[#89AACC]/40 transition-all duration-300">
                    <h3 className="text-lg font-bold text-[#89AACC] mb-3">{skill.category}</h3>
          ...
          {/* Footer */}
          <div className="mt-16 sm:mt-20 md:mt-24 border-t border-[#89AACC]/20">
            <div className="pt-8 sm:pt-12 pb-8">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
                ...
                <div className="flex flex-wrap items-center justify-center gap-3">
                  <a 
                    ...
                    className="inline-flex items-center gap-3 px-4 py-2 bg-[#1a1a1a]/50 hover:bg-[#1a1a1a]/70 text-[#89AACC] border border-[#89AACC]/30 rounded-lg transition-all duration-200 group"
                  >
                    <svg 
                ...
                <div className="flex items-center gap-3">
                  <a 
                    ...
                    className="inline-flex items-center gap-3 px-6 py-3 bg-[#3EEDE7] hover:bg-[#3EEDE7]/80 text-[#161823] rounded-lg transition-all duration-200 group shadow-lg shadow-[#89AACC]/20 hover:shadow-xl hover:shadow-[#89AACC]/30"
                  >
              ...
              {/* Copyright */}
              <div className="mt-8 pt-6 border-t border-[#89AACC]/10 text-center">
